...
public class Reservoir extends SWEntity {
	...
	public Reservoir(MessageRenderer m) {
		...
		this.setSymbol("W");
		this.hitpoints = 40;
		//give the attack affordance to the reservior to let it can be attacked
	...
	/**
	 * this method change the state of reservoir when the hitpoints is decreased
	 * when the hitpoints decrease to 0, the reservoir cannot be attacked anymore
	 */
	public void damageTaken() {
		...
		if(hitpoints <= 0)
		{
			...
			this.setSymbol("X");
			//remove the attack affordance since the hitpoints reached 0
