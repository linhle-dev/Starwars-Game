...
public class Player extends SWActor {
	...
	/**
	 * luke force instantiate from SWForce class
	 */
	private SWForce lukeForce = new SWForce(10);
	...
	/**
	 * implemented method of SWActor method getForce()
	 * return luke's force object
	 */
	@Override
